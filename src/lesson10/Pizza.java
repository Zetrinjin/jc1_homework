...
public class Pizza implements Serializable {//для инкапсуляции implements Serializable
    ...
    public Pizza() {//конструктор должен быть пустым, что бы не сломалась идея инкапсуляции
